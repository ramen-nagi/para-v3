...
class ProfilePageSignIn extends StatefulWidget {
  ...
  @override State<ProfilePageSignIn> createState() => _ProfilePageSignInState();
}
...
class _ProfilePageSignInState extends State<ProfilePageSignIn> {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(padding: const EdgeInsets.all(16), children: [
      ...
      FilledButton(onPressed: _loading ? null : _submit, child: Text(_loading ? 'Signing in...' : 'Sign in')),
      TextButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ProfilePageResetPassword())), child: const Text('Forgot password?')),
      TextButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ProfilePageSignUp())), child: const Text('Create an account')),
    ]),
  );
}
